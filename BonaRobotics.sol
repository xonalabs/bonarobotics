...
contract BonaRobotics is ERC721URIStorage {
    ...
    string public json_ipfs_id = "QmW2vNYPqtk253RzUQB4kpsgqYEbaxsF94WTjDmqc4rsEM";
    ...
    uint256 public phase2_fee = 0.00991 ether;
    uint256 public phase3_fee = 0.0303 ether;


    constructor() ERC721("BonaRobotics", "BROB") {
        OWNER1 = msg.sender;
    ...
    function append_free_phase_address(address addr) internal {
    ...
    function check_the_mint_phase_fee() internal {
        if (robots_counter >= 0 && robots_counter < 10000 && free_claim_end_timestamp > block.timestamp) {
            ...
            append_free_phase_address(msg.sender);
        }
